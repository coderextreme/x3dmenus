...
def displayNavigation(prev_url, next_url):
    group = Group()
...
def menuItem(url, description, label, translation=[-1.8, 1, 7.5], textTranslation=[0.05, -0.011, 0], load=False, size=[1, 0.1], fontSize=0.05, spacing=0.6, thumbnail_url=None, thumbnail_size=[0.1, 0.1]):
    group = Group(
        children=[
            Anchor(
                                    ...
                                    Transform(
                                        ...
                                        children=[
                                            Shape(
                                                ...
                                                geometry=Rectangle2D(
                                                    size=thumbnail_size or [0.1, 0.1] 
                                                )
                                            )
                                        ]
                                    )
        ...
        model =  X3D(
            ...
            Scene=Scene(
                children=[
                    ...
                    displayMenu(page_folders, "FolderScript", url),
                    displayMenu(page_files, "FileScript", url),
                    displayNavigation(prev_url, next_url)
                ]
            )
        )
